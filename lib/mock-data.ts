...
export const mockMatches: Match[] = [
  ...
  {
    id: 'match-4',
    homeTeam: bundesligaTeams[6],
    awayTeam: bundesligaTeams[7],
    status: 'scheduled',
    minute: 0,
    homeScore: 0,
    awayScore: 0,
  ...
  {
    id: 'match-5',
    homeTeam: bundesligaTeams[8],
    awayTeam: bundesligaTeams[9],
    status: 'finished',
    minute: 90,
    homeScore: 1,
    awayScore: 3,
...
export const mockUser: User = {
  ...
  favoriteTeam: 'bay',
  followedMatches: ['match-1', 'match-2', 'match-3', 'match-4', 'match-5'],
